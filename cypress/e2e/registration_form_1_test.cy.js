...
describe('This is first test suite, Ranel Ülper', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Ranel')
        cy.get('#lastName').type('Ülper')
        cy.get('input[name="password"]').type('PasswordTesting1')
        cy.get('[name="confirm"]').type('PasswordTesting1')
    ...
    */
    ...
    it('User cannot submit data when phone number is absent', () => {
        ...
        cy.get('#username').type('RanelYlper')
